...
class Observer:
    ...
    def draw_turn(self, turn : int, data : list[str]):
        ...
        self.canv.create_line(256, 250, 256, 400, fill='black', dash=(4, 16))
        self.canv.create_line(768, 250, 768, 400, fill='black', dash=(4, 16))
        ...
        for i in range(2, len(data)):
            ...
            self.canv.create_image((i-2)*32, y, anchor=tk.NW, image=self.imgs[o == player2_name][t])
            self.canv.create_rectangle((i-2)*32, y, (i-1)*32, y + 4, fill='gray')
            self.canv.create_rectangle((i-2)*32, y, (i-2)*32 + h*32//m, y + 4, fill='green')
